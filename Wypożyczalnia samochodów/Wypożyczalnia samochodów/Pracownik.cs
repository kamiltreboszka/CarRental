...
namespace Wypożyczalnia_samochodów
{
    ...
    public class Pracownik : Osoba
    {
        ...
        public Pracownik(string Imie, string Nazwisko, string Pesel) : base(Imie, Nazwisko, Pesel)
        {
        }
        public override void WprowadzDane()
        {
            while (true)
            {
                Console.WriteLine("Podaj dane praacownika: ");
                try
                {
                    Console.Write("Imie: ");
                ...
                {
                    Console.WriteLine("Wprowadziłeś błedne dane pracownika!");
                }
            }
        }
